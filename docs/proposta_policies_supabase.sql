...
grant select, insert, update on public.catalogo_dados_profissionais to anon, authenticated;
grant select, insert, update on public.dados_profissionais_atendimento to anon, authenticated;
